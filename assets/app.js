...
const api=async (url,opt={})=>{
  const r=await fetch(url,{headers:{'content-type':'application/json'},credentials:'include',...opt});
...
function renderShell(){
  $('#userLabel').textContent=state.user?.username||'Guest';
